...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative rounded-full bg-white border border-neutral-200 shadow-md flex justify-center space-x-4 px-8 py-6"
    >
      {children}
    </nav>
  );
...
export const ProductItem = ({
  ...
  return (
    <a href={href} className="flex space-x-2">
      ...
      />
      <div>
        <h4 className="text-xl font-bold mb-1 text-neutral-900">{title}</h4>
...
export const HoveredLink = ({ children, ...rest }: HoveredLinkProps) => {
  return (
    <a {...rest} className="text-neutral-700 hover:text-neutral-900">
      {children}
    </a>
  );
};
